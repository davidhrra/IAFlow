...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++17",
        "name": "cython_core_functions",
        "sources": [
            "cython_core_functions.pyx"
        ]
    },
    "module_name": "cython_core_functions"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cython_core_functions
#define __PYX_HAVE_API__cython_core_functions
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'cython_core_functions' */
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static double __pyx_v_21cython_core_functions_e;
static int __pyx_v_21cython_core_functions_num_threads;
...
static __Pyx_memviewslice __pyx_f_21cython_core_functions_leakyReluDerivative(__Pyx_memviewslice, double, int __pyx_skip_dispatch); /*proto*/
static __Pyx_memviewslice __pyx_f_21cython_core_functions_sigmoid(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static __Pyx_memviewslice __pyx_f_21cython_core_functions_leakyReLU(__Pyx_memviewslice, double, int __pyx_skip_dispatch); /*proto*/
static __Pyx_memviewslice __pyx_f_21cython_core_functions_softmax(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "cython_core_functions"
extern int __pyx_module_is_main_cython_core_functions;
int __pyx_module_is_main_cython_core_functions = 0;

/* Implementation of 'cython_core_functions' */
...
static PyObject *__pyx_pf_21cython_core_functions_leakyReluDerivative(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, double __pyx_v_alpha); /* proto */
static PyObject *__pyx_pf_21cython_core_functions_2sigmoid(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x); /* proto */
static PyObject *__pyx_pf_21cython_core_functions_4leakyReLU(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, double __pyx_v_alpha); /* proto */
static PyObject *__pyx_pf_21cython_core_functions_6softmax(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x); /* proto */
...
static PyObject *__pyx_pw_21cython_core_functions_1leakyReluDerivative(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_21cython_core_functions_leakyReluDerivative(__Pyx_memviewslice __pyx_v_x, double __pyx_v_alpha, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  __Pyx_RefNannySetupContext("leakyReluDerivative", 0);

  /* "cython_core_functions.pyx":13
 * @cython.nonecheck(False)
 * cpdef double[:] leakyReluDerivative(double[:] x, double alpha):
 *     cdef int xLen = x.shape[0], i = 0             # <<<<<<<<<<<<<<
 *     with nogil, parallel(num_threads = num_threads):
 ...
 */
  __pyx_v_xLen = (__pyx_v_x.shape[0]);
  __pyx_v_i = 0;

  /* "cython_core_functions.pyx":14
 * cpdef double[:] leakyReluDerivative(double[:] x, double alpha):
 *     cdef int xLen = x.shape[0], i = 0
 *     with nogil, parallel(num_threads = num_threads):             # <<<<<<<<<<<<<<
 *         for i in prange(xLen):
      ...
      /*try:*/ {
        {
            ...
            #endif
            #ifdef _OPENMP
            #pragma omp parallel  private(__pyx_t_1, __pyx_t_2, __pyx_t_3, __pyx_t_4, __pyx_t_5, __pyx_t_6, __pyx_t_7) num_threads(__pyx_v_21cython_core_functions_num_threads)
            #endif /* _OPENMP */
            {

                /* "cython_core_functions.pyx":15
 *     cdef int xLen = x.shape[0], i = 0
 *     with nogil, parallel(num_threads = num_threads):
 *         for i in prange(xLen):             # <<<<<<<<<<<<<<
 *             if x[i] >= 0:
 ...
 */
                                __pyx_t_4 = __pyx_v_i;
                                __pyx_t_5 = (((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_4 * __pyx_v_x.strides[0]) ))) >= 0.0) != 0);
                                if (__pyx_t_5) {

                                  /* "cython_core_functions.pyx":17
 *         for i in prange(xLen):
 *             if x[i] >= 0:
 *                 x[i] = 1.0             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
                                  __pyx_t_6 = __pyx_v_i;
                                  *((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_6 * __pyx_v_x.strides[0]) )) = 1.0;
 ...
 */
                                /*else*/ {
                                  __pyx_t_7 = __pyx_v_i;
                                  *((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_7 * __pyx_v_x.strides[0]) )) = __pyx_v_alpha;
                                }
                                __pyx_L14:;
                            }
                        }
...
/* Python wrapper */
static PyObject *__pyx_pw_21cython_core_functions_1leakyReluDerivative(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_21cython_core_functions_1leakyReluDerivative(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_alpha;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("leakyReluDerivative (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_alpha)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("leakyReluDerivative", 1, 2, 2, 1); __PYX_ERR(0, 12, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "leakyReluDerivative") < 0)) __PYX_ERR(0, 12, __pyx_L3_error)
      }
    ...
    __pyx_v_alpha = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_alpha == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("leakyReluDerivative", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 12, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_core_functions.leakyReluDerivative", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_21cython_core_functions_leakyReluDerivative(__pyx_self, __pyx_v_x, __pyx_v_alpha);
...
static PyObject *__pyx_pf_21cython_core_functions_leakyReluDerivative(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, double __pyx_v_alpha) {
  ...
  __pyx_t_1 = __pyx_f_21cython_core_functions_leakyReluDerivative(__pyx_v_x, __pyx_v_alpha, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 12, __pyx_L1_error)
...
static PyObject *__pyx_pw_21cython_core_functions_3sigmoid(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static __Pyx_memviewslice __pyx_f_21cython_core_functions_sigmoid(__Pyx_memviewslice __pyx_v_x, CYTHON_UNUSED int __pyx_skip_dispatch) {
  CYTHON_UNUSED int __pyx_v_xLen;
  int __pyx_v_i;
  __Pyx_memviewslice __pyx_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_RefNannyDeclarations
      ...
      /*try:*/ {
        {
            ...
            #endif
            #ifdef _OPENMP
            #pragma omp parallel  private(__pyx_t_1, __pyx_t_2, __pyx_t_3, __pyx_t_4, __pyx_t_5, __pyx_t_6) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb) num_threads(__pyx_v_21cython_core_functions_num_threads)
            #endif /* _OPENMP */
            {
                #ifdef _OPENMP
                #ifdef WITH_THREAD
 ...
 */
                                __pyx_t_4 = __pyx_v_i;
                                __pyx_t_5 = (1.0 + pow(__pyx_v_21cython_core_functions_e, (-(*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_4 * __pyx_v_x.strides[0]) ))))));
                                ...
                                __pyx_t_6 = __pyx_v_i;
                                *((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_6 * __pyx_v_x.strides[0]) )) = (1.0 / __pyx_t_5);
                                goto __pyx_L15;
                                __pyx_L12_error:;
                                {
                                    #ifdef WITH_THREAD
 ...
 */
  ...
  __Pyx_AddTraceback("cython_core_functions.sigmoid", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
/* Python wrapper */
static PyObject *__pyx_pw_21cython_core_functions_3sigmoid(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static PyObject *__pyx_pw_21cython_core_functions_3sigmoid(PyObject *__pyx_self, PyObject *__pyx_arg_x) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("sigmoid (wrapper)", 0);
  assert(__pyx_arg_x); {
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_arg_x, PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_core_functions.sigmoid", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_21cython_core_functions_2sigmoid(__pyx_self, __pyx_v_x);
...
static PyObject *__pyx_pf_21cython_core_functions_2sigmoid(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_memviewslice __pyx_t_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_t_2 = NULL;
  ...
  __pyx_t_1 = __pyx_f_21cython_core_functions_sigmoid(__pyx_v_x, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 25, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __PYX_XDEC_MEMVIEW(&__pyx_t_1, 1);
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;
...
static PyObject *__pyx_pw_21cython_core_functions_5leakyReLU(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_21cython_core_functions_leakyReLU(__Pyx_memviewslice __pyx_v_x, double __pyx_v_alpha, CYTHON_UNUSED int __pyx_skip_dispatch) {
  CYTHON_UNUSED int __pyx_v_xLen;
  int __pyx_v_i;
  __Pyx_memviewslice __pyx_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_RefNannyDeclarations
      ...
      /*try:*/ {
        {
            ...
            #endif
            #ifdef _OPENMP
            #pragma omp parallel  private(__pyx_t_1, __pyx_t_2, __pyx_t_3, __pyx_t_4, __pyx_t_5, __pyx_t_6, __pyx_t_7, __pyx_t_8, __pyx_t_9) num_threads(__pyx_v_21cython_core_functions_num_threads)
            #endif /* _OPENMP */
            {

                /* "cython_core_functions.pyx":38
 *     cdef int xLen = x.shape[0], i = 0
 *     with nogil, parallel(num_threads = num_threads):
 *         for i in prange(xLen):             # <<<<<<<<<<<<<<
 *             if x[i] >= 0:
 ...
 */
                                  __pyx_t_6 = __pyx_v_i;
                                  __pyx_t_7 = __pyx_v_i;
                                  *((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_7 * __pyx_v_x.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_6 * __pyx_v_x.strides[0]) )));
 ...
 */
                                /*else*/ {
                                  __pyx_t_8 = __pyx_v_i;
                                  __pyx_t_9 = __pyx_v_i;
                                  *((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_9 * __pyx_v_x.strides[0]) )) = (__pyx_v_alpha * (*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_8 * __pyx_v_x.strides[0]) ))));
                                }
                                __pyx_L14:;
                            }
                        }
...
/* Python wrapper */
static PyObject *__pyx_pw_21cython_core_functions_5leakyReLU(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_21cython_core_functions_5leakyReLU(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_alpha;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("leakyReLU (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_alpha)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("leakyReLU", 1, 2, 2, 1); __PYX_ERR(0, 35, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "leakyReLU") < 0)) __PYX_ERR(0, 35, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_alpha = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_alpha == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 35, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("leakyReLU", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 35, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_core_functions.leakyReLU", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_21cython_core_functions_4leakyReLU(__pyx_self, __pyx_v_x, __pyx_v_alpha);
...
static PyObject *__pyx_pf_21cython_core_functions_4leakyReLU(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, double __pyx_v_alpha) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_memviewslice __pyx_t_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_t_2 = NULL;
  ...
  __pyx_t_1 = __pyx_f_21cython_core_functions_leakyReLU(__pyx_v_x, __pyx_v_alpha, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 35, __pyx_L1_error)
...
static PyObject *__pyx_pw_21cython_core_functions_7softmax(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static __Pyx_memviewslice __pyx_f_21cython_core_functions_softmax(__Pyx_memviewslice __pyx_v_x, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_j;
  int __pyx_v_examples;
  int __pyx_v_example;
  int __pyx_v_units;
  PyObject *__pyx_v_prex_return = NULL;
  PyObject *__pyx_v_pre_sum = NULL;
  __Pyx_memviewslice __pyx_v_x_return = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_i_sum = { 0, 0, { 0 }, { 0 }, { 0 } };
 ...
 */
  ...
  __pyx_v_example = 0;
  __pyx_v_units = (__pyx_v_x.shape[1]);

  /* "cython_core_functions.pyx":52
 * cpdef double[:,:] softmax(double[:,:] x):
 *     cdef int j = 0, examples = x.shape[0], example = 0, units = x.shape[1]
 *     prex_return = cvarray(shape=(examples, units), itemsize=sizeof(double), format='d')             # <<<<<<<<<<<<<<
 *     pre_sum = cvarray(shape=(examples,1), itemsize=sizeof(double), format='d')
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_examples); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_units); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 52, __pyx_L1_error)
  ...
  __pyx_t_2 = 0;
  __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_shape, __pyx_t_4) < 0) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyInt_FromSize_t((sizeof(double))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_itemsize, __pyx_t_4) < 0) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_format, __pyx_n_s_d) < 0) __PYX_ERR(0, 52, __pyx_L1_error)
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)__pyx_array_type), __pyx_empty_tuple, __pyx_t_1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_prex_return = __pyx_t_4;
  __pyx_t_4 = 0;

  /* "cython_core_functions.pyx":53
 *     cdef int j = 0, examples = x.shape[0], example = 0, units = x.shape[1]
 *     prex_return = cvarray(shape=(examples, units), itemsize=sizeof(double), format='d')
 *     pre_sum = cvarray(shape=(examples,1), itemsize=sizeof(double), format='d')             # <<<<<<<<<<<<<<
 *     cdef double [:,:] x_return = prex_return
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_examples); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_shape, __pyx_t_3) < 0) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_FromSize_t((sizeof(double))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_itemsize, __pyx_t_3) < 0) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_format, __pyx_n_s_d) < 0) __PYX_ERR(0, 53, __pyx_L1_error)
  __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)__pyx_array_type), __pyx_empty_tuple, __pyx_t_4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_pre_sum = __pyx_t_3;
  __pyx_t_3 = 0;

  /* "cython_core_functions.pyx":54
 *     prex_return = cvarray(shape=(examples, units), itemsize=sizeof(double), format='d')
 *     pre_sum = cvarray(shape=(examples,1), itemsize=sizeof(double), format='d')
 *     cdef double [:,:] x_return = prex_return             # <<<<<<<<<<<<<<
 *     cdef double[:,:] i_sum = pre_sum
 ...
 */
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_v_prex_return, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 54, __pyx_L1_error)
  __pyx_v_x_return = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "cython_core_functions.pyx":55
 *     pre_sum = cvarray(shape=(examples,1), itemsize=sizeof(double), format='d')
 *     cdef double [:,:] x_return = prex_return
 *     cdef double[:,:] i_sum = pre_sum             # <<<<<<<<<<<<<<
 *     cdef double result = 0
 *     i_sum[:,:] = 0
 */
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_v_pre_sum, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 55, __pyx_L1_error)
  __pyx_v_i_sum = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "cython_core_functions.pyx":56
 *     cdef double [:,:] x_return = prex_return
 *     cdef double[:,:] i_sum = pre_sum
 *     cdef double result = 0             # <<<<<<<<<<<<<<
 *     i_sum[:,:] = 0
 ...
 */
  {
      ...
      {
          Py_ssize_t __pyx_temp_extent_0 = __pyx_v_i_sum.shape[0];
          Py_ssize_t __pyx_temp_stride_0 = __pyx_v_i_sum.strides[0];
          char *__pyx_temp_pointer_0;
          Py_ssize_t __pyx_temp_idx_0;
          Py_ssize_t __pyx_temp_extent_1 = __pyx_v_i_sum.shape[1];
          Py_ssize_t __pyx_temp_stride_1 = __pyx_v_i_sum.strides[1];
          char *__pyx_temp_pointer_1;
          Py_ssize_t __pyx_temp_idx_1;
          __pyx_temp_pointer_0 = __pyx_v_i_sum.data;
      ...
      /*try:*/ {
        {
            ...
            #endif
            #ifdef _OPENMP
            #pragma omp parallel  private(__pyx_t_10, __pyx_t_11, __pyx_t_12, __pyx_t_13, __pyx_t_14, __pyx_t_15, __pyx_t_16, __pyx_t_17, __pyx_t_18, __pyx_t_19, __pyx_t_20, __pyx_t_21, __pyx_t_6, __pyx_t_7, __pyx_t_8, __pyx_t_9) num_threads(__pyx_v_21cython_core_functions_num_threads)
            #endif /* _OPENMP */
            {

                /* "cython_core_functions.pyx":59
 *     i_sum[:,:] = 0
 *     with nogil, parallel(num_threads=num_threads):
 *         for example in prange(examples):             # <<<<<<<<<<<<<<
 *             for j in range(units):
 ...
 */
                ...
                if (1 == 0) abort();
                {
                    ...
                    {
                        #ifdef _OPENMP
                        #pragma omp for firstprivate(__pyx_v_example) lastprivate(__pyx_v_example) lastprivate(__pyx_v_j) lastprivate(__pyx_v_result)
                        #endif /* _OPENMP */
                        for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_8; __pyx_t_7++){
                            {
                                __pyx_v_example = (int)(0 + 1 * __pyx_t_7);
                                /* Initialize private variables to invalid values */
                                __pyx_v_j = ((int)0xbad0bad0);
                                __pyx_v_result = ((double)__PYX_NAN());

                                /* "cython_core_functions.pyx":60
 *     with nogil, parallel(num_threads=num_threads):
 *         for example in prange(examples):
 *             for j in range(units):             # <<<<<<<<<<<<<<
 *                 result = e ** x[example,j]
 ...
 */
                                __pyx_t_9 = __pyx_v_units;
                                __pyx_t_10 = __pyx_t_9;
                                for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
                                  __pyx_v_j = __pyx_t_11;

                                  /* "cython_core_functions.pyx":61
 *         for example in prange(examples):
 *             for j in range(units):
 *                 result = e ** x[example,j]             # <<<<<<<<<<<<<<
 *                 x_return[example, j] = result
 ...
 */
                                  __pyx_t_12 = __pyx_v_example;
                                  __pyx_t_13 = __pyx_v_j;
                                  __pyx_v_result = pow(__pyx_v_21cython_core_functions_e, (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_x.data + __pyx_t_12 * __pyx_v_x.strides[0]) ) + __pyx_t_13 * __pyx_v_x.strides[1]) ))));

                                  /* "cython_core_functions.pyx":62
 *             for j in range(units):
 *                 result = e ** x[example,j]
 *                 x_return[example, j] = result             # <<<<<<<<<<<<<<
 *                 i_sum[example,0] += result
 *             for j in range(units):
 */
                                  __pyx_t_14 = __pyx_v_example;
                                  __pyx_t_15 = __pyx_v_j;
                                  *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_x_return.data + __pyx_t_14 * __pyx_v_x_return.strides[0]) ) + __pyx_t_15 * __pyx_v_x_return.strides[1]) )) = __pyx_v_result;

                                  /* "cython_core_functions.pyx":63
 *                 result = e ** x[example,j]
 *                 x_return[example, j] = result
 *                 i_sum[example,0] += result             # <<<<<<<<<<<<<<
 *             for j in range(units):
 ...
 */
                                  ...
                                  __pyx_t_17 = 0;
                                  *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_i_sum.data + __pyx_t_16 * __pyx_v_i_sum.strides[0]) ) + __pyx_t_17 * __pyx_v_i_sum.strides[1]) )) += __pyx_v_result;
                                }

                                /* "cython_core_functions.pyx":64
 *                 x_return[example, j] = result
 *                 i_sum[example,0] += result
 *             for j in range(units):             # <<<<<<<<<<<<<<
 *                 x_return[example, j] /= i_sum[example,0]
 ...
 */
                                ...
                                for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
                                  ...
                                  /* "cython_core_functions.pyx":65
 *                 i_sum[example,0] += result
 *             for j in range(units):
 *                 x_return[example, j] /= i_sum[example,0]             # <<<<<<<<<<<<<<
 *     return x_return
 */
                                  __pyx_t_18 = __pyx_v_example;
                                  __pyx_t_19 = 0;
                                  __pyx_t_20 = __pyx_v_example;
                                  __pyx_t_21 = __pyx_v_j;
                                  *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_x_return.data + __pyx_t_20 * __pyx_v_x_return.strides[0]) ) + __pyx_t_21 * __pyx_v_x_return.strides[1]) )) /= (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_i_sum.data + __pyx_t_18 * __pyx_v_i_sum.strides[0]) ) + __pyx_t_19 * __pyx_v_i_sum.strides[1]) )));
                                }
                            }
                        }
                    }
 ...
 */
  ...
  /* "cython_core_functions.pyx":66
 *             for j in range(units):
 *                 x_return[example, j] /= i_sum[example,0]
 *     return x_return             # <<<<<<<<<<<<<<
 */
  __PYX_INC_MEMVIEW(&__pyx_v_x_return, 0);
  __pyx_r = __pyx_v_x_return;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("cython_core_functions.softmax", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
  ...
  __pyx_L2:;
  __Pyx_XDECREF(__pyx_v_prex_return);
  __Pyx_XDECREF(__pyx_v_pre_sum);
  __PYX_XDEC_MEMVIEW(&__pyx_v_x_return, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_i_sum, 1);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_21cython_core_functions_7softmax(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static PyObject *__pyx_pw_21cython_core_functions_7softmax(PyObject *__pyx_self, PyObject *__pyx_arg_x) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("softmax (wrapper)", 0);
  assert(__pyx_arg_x); {
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_arg_x, PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 50, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_core_functions.softmax", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_21cython_core_functions_6softmax(__pyx_self, __pyx_v_x);
...
static PyObject *__pyx_pf_21cython_core_functions_6softmax(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_memviewslice __pyx_t_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_t_2 = NULL;
  __Pyx_RefNannySetupContext("softmax", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_x.memview)) { __Pyx_RaiseUnboundLocalError("x"); __PYX_ERR(0, 50, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_21cython_core_functions_softmax(__pyx_v_x, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 50, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "cython_core_functions.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "cython_core_functions.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "cython_core_functions.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cython_core_functions._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"leakyReluDerivative", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_21cython_core_functions_1leakyReluDerivative, METH_VARARGS|METH_KEYWORDS, 0},
  {"sigmoid", (PyCFunction)__pyx_pw_21cython_core_functions_3sigmoid, METH_O, 0},
  {"leakyReLU", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_21cython_core_functions_5leakyReLU, METH_VARARGS|METH_KEYWORDS, 0},
  {"softmax", (PyCFunction)__pyx_pw_21cython_core_functions_7softmax, METH_O, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_cython_core_functions(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cython_core_functions},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcython_core_functions(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcython_core_functions(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cython_core_functions(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cython_core_functions(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cython_core_functions(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cython_core_functions' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cython_core_functions(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cython_core_functions", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cython_core_functions) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cython_core_functions")) {
      if (unlikely(PyDict_SetItemString(modules, "cython_core_functions", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 
 */
  __pyx_v_21cython_core_functions_e = 2.718281828459045;

  /* "cython_core_functions.pyx":7
 * 
 * cdef double e = 2.718281828459045
 * cdef int num_threads = multiprocessing.cpu_count()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_21cython_core_functions_num_threads = __pyx_t_3;

  /* "cython_core_functions.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cython_core_functions", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cython_core_functions");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
